...
public class OyunController {
    ...
    public Label oyuncu2adi;
    public Label oyuncu1adi;
    int hamle;
    ...
    public void hamleBitti()
    {
        ...
        {
            System.out.println("Hamle Tükendi!"+ oyuncu1.getOyuncuadi()+ " kazandı!");
            labelKazanan.setText("Hamle Kalmadı." + oyuncu1.getOyuncuadi()+ " kazandı!");
            oynaButonu.setDisable(true);

        }
        else
        {
            System.out.println("Hamle Tükendi! " + oyuncu2.getOyuncuadi()+ " kazandı!");
            labelKazanan.setText("Hamle Kalmadı. "+ oyuncu2.getOyuncuadi()+" kazandı!");
            oynaButonu.setDisable(true);
    ...
    public void OyunaBaslaButonu() throws IOException, InterruptedException {
        ...
        if(hamleSayisiGirdisiKontrol())
        {
            ...
            if(oyunTipiComboBox.getSelectionModel().getSelectedIndex()==0)
            {
                oyuncu1.setOyuncuadi(kullaniciadi.getText());
                oyuncu1adi.setText(oyuncu1.getOyuncuadi());
                oyuncu2adi.setText(oyuncu2.getOyuncuadi());
                Oyun.main(0);
                oyuncu1= Oyun.oyuncu;
